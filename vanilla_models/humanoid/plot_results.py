...
MODELOS = {
    "PPO":      f"{RESULTS_DIR}/Humanoid_PPO_entrenamiento.csv",
    "PPO gSDE": f"{RESULTS_DIR}/Humanoid_PPO_gSDE_entrenamiento.csv",
    "SAC":      f"{RESULTS_DIR}/Humanoid_SAC_entrenamiento.csv",
    "SAC gSDE": f"{RESULTS_DIR}/Humanoid_SAC_gSDE_entrenamiento.csv",
}
...
plt.title("Humanoid — Recompensa por Episodio")
plt.legend(loc="upper left")
plt.grid(True)
plt.tight_layout()
plt.savefig(f"{RESULTS_DIR}/Humanoid_episode_rewards.png")
print("✅ Guardado: Humanoid_episode_rewards.png")
plt.close()
...
plt.xlabel("Pasos")
plt.ylabel("Recompensa total")
plt.title("Humanoid — Recompensa por Pasos")
plt.legend(loc="upper left")
plt.grid(True)
plt.tight_layout()
plt.savefig(f"{RESULTS_DIR}/Humanoid_rewards_step.png")
print("✅ Guardado: Humanoid_rewards_step.png")
plt.close()