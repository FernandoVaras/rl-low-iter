...
VANILLA_DIR = os.path.join(os.path.dirname(__file__), "..", "..",
                            "vanilla_models", "ant", "results")
FSSA_DIR = os.path.join(os.path.dirname(__file__), "results")

MODELOS = {
    "PPO":      f"{VANILLA_DIR}/Ant_PPO_entrenamiento.csv",
    "PPO gSDE": f"{VANILLA_DIR}/Ant_PPO_gSDE_entrenamiento.csv",
    "PPO FSSA": f"{FSSA_DIR}/Ant_FSSA_PPO_entrenamiento.csv",
}
...
plt.title("Ant — Recompensa por Episodio (PPO vs PPO gSDE vs PPO FSSA)")
plt.legend(loc="upper left")
plt.grid(True)
plt.tight_layout()
plt.savefig(f"{FSSA_DIR}/Ant_FSSA_episode_rewards.png")
print("✅ Guardado: Ant_FSSA_episode_rewards.png")
plt.close()
...
plt.xlabel("Pasos")
plt.ylabel("Recompensa total")
plt.title("Ant — Recompensa por Pasos (PPO vs PPO gSDE vs PPO FSSA)")
plt.legend(loc="upper left")
plt.grid(True)
plt.tight_layout()
plt.savefig(f"{FSSA_DIR}/Ant_FSSA_rewards_step.png")
print("✅ Guardado: Ant_FSSA_rewards_step.png")
plt.close()